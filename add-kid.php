    ...
    <div class="center">
        <form action="process.php" method="POST">
            ...
            <div class="form-group" style="display:flex; justify-content: end; margin: 0px !important;">
                <input type="submit" class="btn" style="background-color: brown; color: white; font-weight: 600; " name="subjoinkid" value="Sign Up">
            </div>
            <a href="index.php"><small id="emailHelp" class="form-text text-light">Go To Dashboard.</small></a>
