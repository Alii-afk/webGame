    ...
    <div class="center">
        <form action="process.php" method="POST">
            ...
            <div class="form-group" style="display:flex; justify-content: end; margin: 0px !important;">
                ...
                <input type="submit" class="btn" style="background-color: brown; color: white; font-weight: 600; " name="sublogin" value="Log in">
            </div>
            <a href="signup.php"><small id="emailHelp" class="form-text text-light">Click to Sign Up First.</small></a>
